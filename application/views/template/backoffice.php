        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                ...
                <li><a href=<?php echo base_url('utilisateur/home'); ?>>ACCEUIL</a></li>
                    ...
                    <li><a href="<?php echo base_url('utilisateur/proposition');?>">UTILISATEUR INSCRIT</a></li>
                            ...
                            <nav class="navbar navbar-expand-lg justify-content-end">
                                ...
                                <div class="collapse navbar-collapse" id="footerNavContent">
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="product-details.html">Utilisateur inscrit</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="cart.html">échange effectué</a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
